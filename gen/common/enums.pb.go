...
const (
	...
	GameLinkState_IN_LIBRARY     GameLinkState = 2
	GameLinkState_BACKLOG        GameLinkState = 3
	GameLinkState_IN_PROGRESS    GameLinkState = 4
	GameLinkState_DONE           GameLinkState = 5
	GameLinkState_NOT_COMPLETED  GameLinkState = 6
	GameLinkState_RE_PLAYING     GameLinkState = 7
	GameLinkState_ON_PAUSE       GameLinkState = 8
)
...
const file_common_enums_proto_rawDesc = "" +
	"\n" +
	"\x12common/enums.proto\x12\x11game_state.common*\x99\x01\n" +
	"\rGameLinkState\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x12\n" +
	"\x0eNOT_IN_LIBRARY\x10\x01\x12\x0e\n" +
	"\n" +
	"IN_LIBRARY\x10\x02\x12\v\n" +
	"\aBACKLOG\x10\x03\x12\x0f\n" +
	"\vIN_PROGRESS\x10\x04\x12\b\n" +
	"\x04DONE\x10\x05\x12\x11\n" +
	"\rNOT_COMPLETED\x10\x06\x12\x0e\n" +
	"\n" +
	"RE_PLAYING\x10\a\x12\f\n" +
	"\bON_PAUSE\x10\bB>Z<github.com/sariya23/api_game_state_service/gen/common;commonb\x06proto3"
